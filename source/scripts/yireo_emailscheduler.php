...
$send_date = time() + (60*60*24*3);
$email = new EmailScheduler($subject, $body, $recipients, null, null, $send_date);
echo (int)$email->save();*/

// Example 1
$article_id = 6;
$recipients = array('jisse@koans2.org');
$email = new EmailScheduler();
$email->setRecipients($recipients)->setArticle($article_id)->save();
